...
A little shout to the Microsoft MVP [Luca Del Puppo](https://www.delpuppo.net/), check out his articles on how to use Orama inside a React application:
...
And another little shout to [Balastrong](https://github.com/balastrong) aka [DevLeonardo](https://www.youtube.com/c/DevLeonardo) for helping me in the early steps of the integration of Orama inside an Astro blog!
